...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "nhunhat0210";
        LicenseKey = "LJ2VQG88RDG66J172PYBLG9LY8NBAD1A";
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "avi", "bmp", "csv", "doc", "docx", "gif", "jpeg", "jpg", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "pdf", "png", "tif", "tiff", "txt", "wav", "wma", "wmv", "xls", "xlsx" };
